...
define("_INSTALLER_TITLE", "Инсталляция Docebo 4.0");
...
define("_INSTALLER_INTRO_TEXT", "Компания Docebo разработала собственную обучающую систему с открытым кодом, DoceboLMS, пригодную для применения в курпных организациях, корпоративном секторе, правительстве и здравоохранении.
	...
	<ul>
		...
		<li>Много-языковая поддержка, поддержка письма LTR(слева-направо) и RTL (справа-налево). Поддерживаются 18 языков</li>
...
// -----------------------------------------
define("_UPGRADER_TITLE", "Docebo 4.0 - Обновление");
