...
define("_SQL_STRICT_MODE_WARN", "La modalit&agrave; <a href=\"http://dev.mysql.com/doc/en/server-sql-mode.html\" target=\"_blank\">strict mode</a> di MySQL &egrave; attiva; Docebo LMS non la supporta, ti preghiamo di disattivarla");
...
define("_END","Finale");
define("_INVALID_CONFIG_FILE", "File config.php non valido; assicurati che sia della versione di Docebo specificata alla voce \"Iniziale\"");
define("_UPGRADE_NOT_NEEDED","Hai già l'ultima versione di Docebo; non è necessario aggiornare.");
