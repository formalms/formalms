...
// router
__webpack_require__(8).pushState(false);
...
var PushState = __webpack_require__(11);
var $ = __webpack_require__(0);
...
var Router = function () {
    ...
    function onPagesLoaded(pages, currentRoute) {
        ...
        if (currentRoute) {
            var _currentPage = __webpack_require__(3)("./" + currentRoute.route);
            new _currentPage({
                page: currentRoute,
                config: CONFIG
            }).onLoad();
    ...
    function onPushStateChange(history, pages, currentRoute, params) {
        if (pages && pages[currentRoute] && history.pages.indexOf(currentRoute) < 0) {
            ...
            var _currentPage = __webpack_require__(3)("./" + pages[currentRoute]);
    ...
    function renderTemplate(content) {
        if (content) {
            var _template = !(function webpackMissingModule() { var e = new Error("Cannot find module \"../../../src/views\""); e.code = 'MODULE_NOT_FOUND'; throw e; }());
