...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo Layout::lang_code(); ?>">
	<head>
		...
		<!-- Restyling -->
		<?php
        Util::get_js(FormaLms\lib\Get::rel_path('base') . '../web/static/main.js?v=' . getTemplateVersion(getDefaultTemplate()), true, true);
        Util::get_css(FormaLms\lib\Get::rel_path('base') . '../web/static/main.css?v=' . getTemplateVersion(getDefaultTemplate()), true, true);
        ?>
	</head>
