...
class DoceboLangManager
{
	...
	function _getTableText()
	{
		return $this->prefix . '_lang_text';
	}

	function _getTableTranslation()
	{
		return $this->prefix . '_lang_translation';
	}

	function _getTableLanguage()
	{
	 ...
	 */
	function getModuleLangTranslations($platform, $module, $lang_code, $trans_contains = '', $attributes = false, $order_by = false, $get_date = false, $text_items = null)
	{
