...
<?php endif; ?>
        ...
        <?php       
         ...
         ?>
                           ...
                           <div  id="container1_<?php echo $stato_corso; ?>">
                            ...
                            <div class="well well-sm"><strong><?php echo Lang::t('_ELEARNING', 'catalogue'); ?></strong></div>                                       
                                    
                                    
                                   <ul class="grid" id='mia_area_<?php echo $stato_corso; ?>'>  
                    ...
                    <li class="completed_course_<?php  echo $course['user_status']; ?>" >
                                                  
                        <div  class="area1" >            
                                            <!-- IMG COURSE -->   
                                             <?php if($course['use_logo_in_courselist'] && $course['img_course']) : ?>
                                                <img class="img-rounded" width="100px" height="100px" 
        ...
        <?php endforeach; ?>                     
                                ...
                                <br>
                                <div class="well well-sm"><strong><?php echo Lang::t('_CLASSROOM', 'standard'); ?></strong></div>                                 
             
                                 <ul class="grid" id='mia_area_class_<?php echo $stato_corso; ?>'>  
...
<?php if( empty($courselistClassroom) ) : ?>
             ...
             <li class="completed_course_<?php  echo $course['user_status']; ?>" >
                        <div class="area1">
                                            <!-- IMG COURSE -->   
                                             <?php if($course['use_logo_in_courselist'] && $course['img_course']) : ?>
                                                <img class="img-thumbnail" width="70px" height="70px" 
                                                    src="<?php echo $path_course.$course['img_course']; ?>"
                                                    alt="<?php echo Util::purge($course['name']); ?>" />
