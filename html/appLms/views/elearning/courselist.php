...
<div id="container1_<?php echo $stato_corso; ?>">
    ...
    <?php switch ($filter_type){
            case 'all': ?>
                <h1 class="page-header col-xs-12"><strong><?php echo Lang::t('_CLASSROOM_COURSE_AND_ELEARNING', 'catalogue'); ?></strong></h1>
                                    ...
                                    <div class="course-box"> <!-- NEW BLOCK -->
                                        ...
                                        <div class="course-box__item course-box__item--no-padding">
                                            ...
                                            <div class="course-box__img"
                                                 style="background-image: url(<?php echo GetCourseImage($course, $path_course) ?>)">
                                                <?php } else { ?>
                                                <div class="course-box__img">
                                                    <?php } ?>
                                        ...
                                        <div class="course-box__date-text">
                                          <span>Data di chiusura</span><br>';
                                            ...
                                            <div class="course-box__item course-box__item<?php if (GetCourseYear($course) > 1) {
                                                echo '--half';
                                            } ?>">
                                                <?php if ($course['can_enter']['can']) { ?>
                                                    <a class="forma-button forma-button--orange-hover forma-button--full"
                                                       title="<?php echo Util::purge($course['name']); ?>"
