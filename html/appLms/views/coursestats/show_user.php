...
$columns = array(
  array('key' => 'path', 'label' => Lang::t('_DEFAULT', 'standard'), 'sortable' => true, 'formatter' => 'CourseUserStats.path'),
...
$params = array(
  ...
  <table style="width:100%" id="coursestats">
    <thead>
      <tr><?php
...
$(function() {
  ...
  var table = $('#coursestats').DataTable({
    "processing": true,
    "serverSide": true,
    "order": [[ 1, "desc" ]],
    "ajax": {
