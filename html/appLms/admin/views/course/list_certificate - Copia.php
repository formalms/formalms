            ...
            echo "<table id='table_certificate' data-tipocorso='".$course_info['course_type']."' data-id_course='".$id_course."' data-id_certificate='".$id_certificate."' class='table table-striped table-bordered display' style='width:100%'>";            
                    echo "<thead>";
                        echo "<tr>";
                            echo "<th></th>";
                            echo "<th></th>";
                            echo "<th data-column_type='string'>".Lang::t('_USERNAME', 'standard')."</th>";
                            echo "<th data-column_type='string'>".Lang::t('_LASTNAME', 'standard')."</th>";
                            echo "<th data-column_type='string'>".Lang::t('_NAME', 'standard')."</th>";
                            echo "<th data-column_type='string'>".Lang::t('_STATE', 'classroom')."</th>"; 
                            echo "<th data-column_type='string'>".Lang::t('_TEMPLATE', 'certificate')."</th>";
                            echo "<th data-column_type='string'>".Lang::t('_EDITION', 'standard')."</th>";
                            echo "<th data-column_type='date'>".Lang::t('_DATE_COMPLETE', 'certificate')."</th>";
                            echo "<th data-column_type='date'>".Lang::t('_CERTIFICATE_RELEASE', 'course')."</th>";
