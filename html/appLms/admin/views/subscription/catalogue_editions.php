...
<div class="std_block">
	...
	<?php
        ...
        if ($tables['editions'] !== false) {
            echo $tables['editions']->getTable();
        }
        if ($tables['editions'] !== false && $tables['classrooms'] !== false) {
            echo '<br /><br />';
        }
        if ($tables['classrooms'] !== false) {
            echo $tables['classrooms']->getTable();
        }
