...
Class CourseAlmsController extends AlmsController
{
	...
	public function certificate()
	{
		...
		if(isset($_POST['assign']))
		{
            ...
            $minutesRequired = Get::req('certificate_assign_minutes', DOTY_INT, 0);
			// , $list_of_assign_obj, $list_of_who
			
			if(!$cert->updateCertificateCourseAssign($id_course, $_POST['certificate_assign'], $_POST['certificate_ex_assign'], $point_required,$minutesRequired))
