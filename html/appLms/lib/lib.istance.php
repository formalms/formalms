...
function createModule($module_name, $class_name = NULL) {
	...
	$module_name = preg_replace('/[^a-zA-Z0-9\-\_]+/', '', $module_name);
        ...
        }else if(file_exists(_base_.'/../class.module/class.'.$module_name.'.php')) {
		
		include_once(_base_.'/../class.module/class.'.$module_name.'.php');
		if( $class_name === NULL ) $class_name = 'Module_'.ucfirst($module_name); 
	} else {

		include_once(_base_.'/../class.module/class.definition.php');
