...
class AssessmentRuleManager
{
    ...
    {
        Util::get_js(FormaLms\lib\Get::rel_path('base') . '/addons/yui/utilities/utilities.js', true, true);
        Util::get_js(FormaLms\lib\Get::rel_path('base') . '/addons/yui/dom/dom.js', true, true);
        Util::get_js(FormaLms\lib\Get::rel_path('base') . '/addons/yui/json/json.js', true, true);
        Util::get_js(FormaLms\lib\Get::rel_path('base') . '/addons/yui/selector/selector.js', true, true);
        Util::get_js(FormaLms\lib\Get::rel_path('base') . '/addons/yui/event/event.js', true, true);
        Util::get_js(FormaLms\lib\Get::rel_path('base') . '/addons/yui/datasource/datasource.js', true, true);
        Util::get_js(FormaLms\lib\Get::rel_path('base') . '/addons/yui/autocomplete/autocomplete.js', true, true);

        Util::get_js(FormaLms\lib\Get::rel_path('lms') . '/modules/test/assessment_rule.js', true, true);
    }
    ...
    public function getAddEditForm($form_url, $data)
    {
        ...
        $res .= '<script type="text/javascript">
			var course_ac_url="' . FormaLms\lib\Get::rel_path('adm')
            . '/ajax.adm_server.php?mn=course&plf=lms&op=course_autocomplete&results=20' . '";
			var competence_ac_url="' . FormaLms\lib\Get::rel_path('adm')
    ...
    public function save()
    {
        ...
        $rule_id = FormaLms\lib\Get::pReq('rule_id', DOTY_INT, 0);
        $test_id = FormaLms\lib\Get::pReq('test_id', DOTY_INT, 0);
        $category_id = FormaLms\lib\Get::pReq('category_id', DOTY_INT, 0);
        $from_score = FormaLms\lib\Get::pReq('from_score', DOTY_INT, 0);
        $to_score = FormaLms\lib\Get::pReq('to_score', DOTY_INT, 0);
        $competences_list = FormaLms\lib\Get::pReq('competences_list', DOTY_STRING, '');
        $courses_list = FormaLms\lib\Get::pReq('courses_list', DOTY_STRING, '');
        $feedback_txt = FormaLms\lib\Get::pReq('feedback_txt', DOTY_MIXED, '');
