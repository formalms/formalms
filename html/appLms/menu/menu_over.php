...
//** DEV: LR - creato un menu_over  responsive  attraverso bootstrap **
    ...
    if ($showProfile || $showCredits) {
        $str_menu_over .= '<div class="tabnav js-tabnav">
                            <div class="tabnav__label-wrapper">';
    }

    if ($showProfile) {
        $str_menu_over .= '<div class="tabnav__label selected" data-tab="profile">
    ...
    if ($showCredits) {
        $str_menu_over .= '<div class="tabnav__label" data-tab="credits">
                                    ' . Lang::t('_TIME_PERIODS', 'time_periods') . '
                                </div>';
    }
    if ($showProfile || $showCredits) {
        $str_menu_over .= '</div>
    ...
    if ($showProfile) {
        $str_menu_over .= '<div class="tabnav__content tabnav__content--profile is-visible">
                                    ' . $profile_box . '                                        
                                </div>';
    }
    if ($showCredits) {
        $str_menu_over .= '<div class="tabnav__content tabnav__content--credits">
    ...
    $str_menu_over .= '<div class="row news">
                            <div class="col-xs-12">
                                ' . $news . '
                            </div> <!-- end col xs-12 -->
                        </div>';
