...
$this->widget('tree', [
    ...
    'treeFile' => FormaLms\lib\Get::rel_path('base') . '/widget/competenceselector/competenceselector.js',
...
$_columns = [
    ['key' => 'name', 'label' => Lang::t('_NAME', 'standard'), 'sortable' => true, 'formatter' => 'CompetenceSelector.labelFormatter'],
    ['key' => 'description', 'label' => Lang::t('_DESCRIPTION', 'standard'), 'sortable' => true, 'formatter' => 'CompetenceSelector.labelFormatter'],
    ['key' => 'typology', 'label' => Lang::t('_TYPOLOGY', 'competences'), 'sortable' => true, 'formatter' => 'CompetenceSelector.labelFormatter'],
    ['key' => 'type', 'label' => Lang::t('_TYPE', 'standard'), 'sortable' => true, 'formatter' => 'CompetenceSelector.labelFormatter'],
...
$this->widget('table', [
    ...
    'columns' => $_columns,
    'fields' => ['id', 'name', 'description', 'typology', 'type'/*, 'score', 'expiration'*/, 'mod', 'del'],
    'stdSelection' => true,
    'stdSelectionField' => '_checked',
    'initialSelection' => $selection,
    'rel_actions' => [$rel_action_over, $rel_action_bottom],
    'events' => ['initEvent' => 'CompetenceSelector.initTableEvent'],
]);
