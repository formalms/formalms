...
<?php if ($use_form_input && $separate_input) {
    echo '<input type="hidden" id="userselector_input_' . $id . '_group" name="userselector_input[' . $id . '][group]" value="" />';
} ?>
...
$params = [
    ...
    'dir' => 'asc',
    'columns' => [
            ['key' => 'groupid', 'label' => Lang::t('_NAME', 'standard'), 'sortable' => true, 'formatter' => $_varname . '.labelFormatter'],
            ['key' => 'description', 'label' => Lang::t('_DESCRIPTION', 'standard'), 'sortable' => true, 'formatter' => $_varname . '.labelFormatter'],
            ['key' => 'usercount', 'label' => Lang::t('_USERS', 'standard'), 'sortable' => false, 'className' => 'img-cell'],
        ],
    'fields' => ['id', 'groupid', 'description', 'usercount'],
