...
class TableWidget extends Widget
{
    ...
    public function run()
    {
        ...
        $params['events'] = (is_array($this->events) ? $this->events : []);
    ...
    protected function _getColumns()
    {
        if ($this->stdSelection) {
            ...
            $columnsList = [['key' => '_select', 'label' => $label, 'formatter' => 'doceboSelect', 'className' => 'img-cell']];
    ...
    {
        if ($this->stdSelection && $this->stdSelectionField) {
            $this->fields[] = $this->stdSelectionField;
        }
    ...
    protected function _useStdSelectFormatter()
    {
        return $this->stdSelection;
        /*
        $result = false;
        if (is_array($this->columns)) {
            foreach ($this->columns as $column) {
