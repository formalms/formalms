<?php
	...
	echo getTitleArea($array_title)
			.'<div class="std_block">'
			.Form::openForm('courses_association_form', 'index.php?r=adm/adminmanager/courses&id_user='.$id_user)
			...
			.Form::openElementSpace()
			.'<div id="course_selector" style="display:'.($all_courses ? 'none' : 'block').';">';
