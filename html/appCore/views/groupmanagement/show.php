...
if ($permissions['associate_user']) {
    $columns[] = ['key' => 'assign', 'label' => $assign_label, 'formatter' => 'GroupManagement.assignFormatter', 'className' => 'img-cell'];
}
if ($permissions['mod']) {
    $columns[] = ['key' => 'mod', 'label' => $mod_label, 'formatter' => 'doceboModify', 'className' => 'img-cell'];
}
if ($permissions['del']) {
    $columns[] = ['key' => 'del', 'label' => $del_label, 'formatter' => 'doceboDelete', 'className' => 'img-cell'];
}
