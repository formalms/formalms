...
$params = [
    ...
    'treeFile' => FormaLms\lib\Get::rel_path('adm') . '/views/competences/competences.js',
...
if ($permissions['associate_user']) {
    $columns[] = ['key' => 'users', 'label' => $icon_users, 'formatter' => 'Competences.usersFormatter', 'className' => 'img-cell'];
}
if ($permissions['mod']) {
    $columns[] = ['key' => 'mod', 'label' => $icon_mod, 'formatter' => 'Competences.modifyFormatter', 'className' => 'img-cell'];
}
if ($permissions['del']) {
...
$params = [
    ...
    'rowsPerPage' => $rowsPerPage, //FormaLms\lib\Get::sett('visuItem', 25),
    'startIndex' => $startIndex,
    'results' => $results, //FormaLms\lib\Get::sett('visuItem', 25),
    'sort' => $sort, //'name',
    'dir' => $dir, //'asc',
