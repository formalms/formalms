...
$params = [
    ...
    'treeFile' => Forma\lib\Get::rel_path('adm') . '/views/competences/competences.js',
...
$params = [
    ...
    'rowsPerPage' => $rowsPerPage, //Forma\lib\Get::sett('visuItem', 25),
    'startIndex' => $startIndex,
    'results' => $results, //Forma\lib\Get::sett('visuItem', 25),
    'sort' => $sort, //'name',
    'dir' => $dir, //'asc',
