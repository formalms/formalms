...
class Admin_Framework_Elearning extends Admin {
	 ...
	 * @access public
	 */
	function Admin_Framework_Elearning(&$user) {
		$this->user =& $user;
		$this->platform = 'framework';
		$this->table_level_one = $GLOBALS['prefix_fw'].'_menu_elearning';
		$this->table_level_two = $GLOBALS['prefix_fw'].'_menu_under_elearning';
       ...
       // echo "<br>step 1: ".$query_menu;
        ...
        $lang     =& DoceboLanguage::createInstance('menu', 'menu_menu_elearning');
	 ...
	 */
	 function getLevelOne() {
        ...
        $lang     =& DoceboLanguage::createInstance('menu', 'menu_elearning');
...
class Admin_Managment_Framework_Elearning extends Admin_Managment {
