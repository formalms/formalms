...
class Admin_Framework_Content extends Admin {
	 ...
	 * @access public
	 */
	function Admin_Framework_Content(&$user) {
		$this->user =& $user;
		$this->platform = 'framework';
		$this->table_level_one = $GLOBALS['prefix_fw'].'_menu_content';
		$this->table_level_two = $GLOBALS['prefix_fw'].'_menu_under_content';
       ...
       // echo "<br>step 1: ".$query_menu;
        ...
        $lang     =& DoceboLanguage::createInstance('menu', 'menu_content');
...
class Admin_Managment_Framework_Content extends Admin_Managment {
