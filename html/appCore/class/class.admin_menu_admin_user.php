...
class Admin_Framework_User extends Admin {
	 ...
	 * @access public
	 */
	function Admin_Framework_User(&$user) {
		$this->user =& $user;
		$this->platform = 'framework';
		$this->table_level_one = $GLOBALS['prefix_fw'].'_menu_user';
		$this->table_level_two = $GLOBALS['prefix_fw'].'_menu_under_user';
        ...
        $lang     =& DoceboLanguage::createInstance('menu', 'menu_user');
...
class Admin_Managment_Framework_User extends Admin_Managment {
