...
class Admin_Framework_Config extends Admin {
	 ...
	 * @access public
	 */
	function Admin_Framework_Config(&$user) {
		$this->user =& $user;
		$this->platform = 'framework';
		$this->table_level_one = $GLOBALS['prefix_fw'].'_menu_config';
		$this->table_level_two = $GLOBALS['prefix_fw'].'_menu_under_config';
       ...
       // echo "<br>step 1: ".$query_menu;
        ...
        $lang     =& DoceboLanguage::createInstance('menu', 'menu_config');
...
class Admin_Managment_Framework_Config extends Admin_Managment {
