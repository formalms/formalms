...
class HomepageAdmController extends AdmController {
    ...
    public function sso() { // index.php?login_user=staff&time=200812101752&token=5D93BCEDF500E9759E4870492AF32E7A
        ...
        if($id_course) {
            ...
            switch($next_action) {
                case "organization":
                    $_SESSION["login_redirect"] = Get::abs_path("lms") . "/index.php?modname=organization&op=custom_playitem&id_item=" . $id_item;
                    break;
                case "playsco":
                    $_SESSION["login_redirect"] = Get::abs_path("lms") . "/index.php?modname=organization&op=custom_playitem&id_course=" . $id_course
