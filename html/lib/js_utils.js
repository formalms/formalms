    ...
    init: function (oConfig) {
        ...
        if (this.overlay_light == null) {
            ...
            YAHOO.util.Event.on(window, "resize", function (e, obj) {
                ...
                if (YAHOO.env.ua.ipad == 0 || typeof YAHOO.env.ua.ipad == "undefined" || !YAHOO.env.ua.ipad) {
                    ...
                    if (YAHOO.util.Dom.getViewportWidth() == 980) {
                        var new_w = (YAHOO.util.Dom.getViewportWidth() - 16 + 48),
                            new_h = (YAHOO.util.Dom.getViewportHeight() - 16 + 32);
                    } else {
                        var new_w = (YAHOO.util.Dom.getViewportWidth() - 16),
                            new_h = (YAHOO.util.Dom.getViewportHeight() - 16);
                    }
            ...
            YAHOO.util.Event.addListener("close_handler", "click", function (e, obj) {
                ...
                var closeHandler = document.getElementById('close_handler');

                if (!closeHandler.getAttribute('data-disabled')) {
                    closeHandler.setAttribute("data-disabled",true);
