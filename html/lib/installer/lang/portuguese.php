...
<ul>
	...
	<li>Características de Colaboração tais como <strong>Fórum</strong>, <strong>Wiki</strong>, <strong>Chat</strong>, <strong>Gestão de Projetos</strong>, <strong>Repositório</strong></li>
	...
	<li>Suporte para interface de terceiros com software de gestão de recursos humanos (<strong>SAP</strong>, <strong>Cezanne</strong>, <strong>Lotus Notes</strong>, ...) e outras companhias de serviço (<strong>LDAP</strong>, <strong>Active Directory</strong>, <strong>CRM</strong>, <strong>ERP</strong> e outras soluções)</li>
	<li>Características sociais tais como <strong>Google Apps</strong>, <strong>Facebook</strong>, <strong>Twitter</strong> e <strong>Linkedin</strong></li>
...
define('_REMOVE_INSTALL_FOLDERS_AND_WRITE_PERM', '<strong>Atenção:</strong> Antes de prosseguir, exclua o diretório install/ do site e remova as permissões de gravação do arquivo config.php, configurando-as para 644');
...
define('_SQL_STRICT_MODE_WARN', 'O modo <a href="http://dev.mysql.com/doc/en/server-sql-mode.html" target="_blank">strict mode</a> do MySQL/MariaDB está ativo; forma.lms não é compatível, desative-o');
define('_SQL_STRICT_MODE', 'MySQL/MariaDB <a href="http://dev.mysql.com/doc/en/server-sql-mode.html" target="_blank">strict mode</a>');
...
define('_WARNING_NOT_INSTALL', '<strong>Atenção</strong>: se você desmarcar um aplicativo ele não estará disponível, mas você pode instalá-lo no futuro usando o procedimento automático.');
