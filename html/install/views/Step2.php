...
<ul class="info">
	...
	<li class="<?php echo $cl['allow_url_fopen']; ?>"><?php echo Lang::t('ALLOW_URL_FOPEN'); ?>: <?php echo ( $php_conf['allow_url_fopen']['local_value'] != '' ? _ON : _OFF.' '._WARINNG_SOCIAL); ?></li>
	<li><?php echo Lang::t('ALLOW_URL_INCLUDE'); ?>: <?php echo ( $php_conf['allow_url_include']['local_value'] != '' ? _ON : _OFF); ?></li>
