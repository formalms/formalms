...
Class Step7Controller extends StepController
{
    ...
    public function ajax_validate()
    {
        ...
        if ($use_smtp === 'on') {
            ...
            if (!$this->checkConnection($smtp_host, $smtp_port, $smtp_secure, $smtp_user, $smtp_pwd)) {
                $err++;
                array_push($res['err'], 'smtp_host', 'smtp_port', 'smtp_secure', 'smtp_user', 'smtp_pwd');
    ...
    function checkConnection($smtp_host, $smtp_port, $smtp_secure, $smtp_user, $smtp_pwd)
    {
