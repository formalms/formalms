...
(501, 501, 'field_manager', '_FIELD_MANAGER', 'field_list', 'view', NULL, 1, 'class.field_manager.php', 'Module_Field_Manager', ''), 
(502, 502, 'customfield_manager', '_CUSTOMFIELD_MANAGER', 'field_list', 'view', NULL, 2, 'class.customfield_manager.php', 'Module_Customfield_Manager', ''), 
(521, 521, 'setting', '_CONFIGURATION', '', 'view', NULL, 1, 'class.configuration.php', 'Module_Configuration', 'adm/setting/show'), 
(523, 523, 'event_manager', '_EVENTMANAGER', 'display', 'view_event_manager', NULL, 3, 'class.event_manager.php', 'Module_Event_Manager', ''), 
(524, 524, 'iotask', '_IOTASK', 'iotask', 'view', NULL, 4, 'class.iotask.php', 'Module_IOTask', ''), 
(526, 526, 'privacypolicy', '_PRIVACYPOLICIES', '', 'view', NULL, 6, '', '', 'adm/privacypolicy/show'), 
(527, 527, 'pluginmanager', '_PLUGIN_MANAGER', '', 'view', NULL, 7, '', '', 'adm/pluginmanager/show'), 
(528, 528, 'code', '_CODE', 'list', 'view', NULL, 8, 'class.code.php', 'Module_Code', ''), 
