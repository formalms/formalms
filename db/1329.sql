...
INSERT INTO `core_role` (`idst`, `roleid`, `description`) VALUES(231, '/lms/admin/coursecategory/add', NULL);
INSERT INTO `core_role` (`idst`, `roleid`, `description`) VALUES(232, '/lms/admin/coursecategory/mod', NULL);
INSERT INTO `core_role` (`idst`, `roleid`, `description`) VALUES(233, '/lms/admin/coursecategory/del', NULL);
