...
INSERT INTO core_lang_translation ( id_text,lang_code,  translation_text, save_date ) VALUES  (LAST_INSERT_ID(), 'english','User status is change in modified', now());

INSERT INTO core_lang_text (id_text, text_key, text_module, text_attributes) VALUES (NULL, '_EVENT_RECIPIENTS_GOD', 'event_manager', '');
INSERT INTO core_lang_translation ( id_text,lang_code,  translation_text, save_date ) VALUES  (LAST_INSERT_ID(), 'english','Super-Administrators', now());

INSERT INTO core_lang_text (id_text, text_key, text_module, text_attributes) VALUES (NULL, '_MOD_USER_SBJ', 'event_manager', '');
INSERT INTO core_lang_translation ( id_text,lang_code,  translation_text, save_date ) VALUES  (LAST_INSERT_ID(), 'english','User has been modified', now());

INSERT INTO core_lang_text (id_text, text_key, text_module, text_attributes) VALUES (NULL, '_MOD_USER_TEXT', 'event_manager', '');
INSERT INTO core_lang_translation ( id_text,lang_code,  translation_text, save_date ) VALUES  (LAST_INSERT_ID(), 'english','User with [firstname] [lastname] and userId : [username] has been modified in platform : [url]', now());
...
INSERT INTO core_lang_translation ( id_text,lang_code,  translation_text, save_date ) VALUES  (LAST_INSERT_ID(), 'english','User has been suspended', now());
...
INSERT INTO core_lang_translation ( id_text,lang_code,  translation_text, save_date ) VALUES  (LAST_INSERT_ID(), 'english','User with [firstname] [lastname] and userId : [username] has been suspended in platform : [url]', now());
...
INSERT INTO core_lang_translation ( id_text,lang_code,  translation_text, save_date ) VALUES  (LAST_INSERT_ID(), 'english','User Node is changes', now());

INSERT INTO core_lang_text (id_text, text_key, text_module, text_attributes) VALUES (NULL, '_CHANGE_NODE_USER_SBJ', 'event_manager', '');
INSERT INTO core_lang_translation ( id_text,lang_code,  translation_text, save_date ) VALUES  (LAST_INSERT_ID(), 'english','User has been change node', now());

INSERT INTO core_lang_text (id_text, text_key, text_module, text_attributes) VALUES (NULL, '_CHANGE_NODE_USER_TEXT', 'event_manager', '');
INSERT INTO core_lang_translation ( id_text,lang_code,  translation_text, save_date ) VALUES  (LAST_INSERT_ID(), 'english','User with [firstname] [lastname] and userId : [username] has been change node in platform : [url]', now());
...
INSERT INTO core_lang_translation ( id_text,lang_code,  translation_text, save_date ) VALUES  (LAST_INSERT_ID(), 'english','User with [firstname] [lastname] and userId : [username] has been suspended from course : [course] in platform : [url]', now());
